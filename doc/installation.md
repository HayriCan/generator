...
To get started, you should add the `hayrican/generator` Composer dependency to your project:
```
...
```
php artisan vendor:publish --provider="Hayrican\CrudGenerator\CrudGeneratorServiceProvider"
```
...
public function register()
{
    if ($this->app->environment() == 'local') {
        $this->app->register('Hayrican\CrudGenerator\CrudGeneratorServiceProvider');
    }
}
```
